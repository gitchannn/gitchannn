## 🌏 안녕하세요! 개발자 깃짱(조은기)입니다

### ✅ About Me

- **연세대학교 컴퓨터과학과 & 산업공학과** 전공 (3.87 / 4.3) `2019.03 ~ 2026.02`
- 개발자 부트캠프 **우아한테크코스** 5기 **백엔드** 수료 `2023.02 ~ 2023.11`
- [주식회사 아이고야랩스](https://github.com/orgs/aigoya-labs/repositories) 대표이사 & Server Developer `2024.07 ~`
- 기술블로그 <a href="https://engineerinsight.tistory.com/" target="_blank">깃짱코딩</a> `2022.11 ~`
- 한국공학한림원 산하 전국 공과대학 연합 동아리 **YEHS** 기획 3부 부장 `2021.05 ~ 2022.12`


### ✅ Project

- [RAG 기반 희귀품종 무화과 LLM 챗봇 프로젝트](https://github.com/AiResearch2025/FigVarietyRAGChat) `2025.10`
- 변리사를 위한 특허 명세서 작성 AI 'drift' 외주 개발 (이조솔루션)
- AI 개발 생산성 플랫폼 'aigoya' `2024.04 ~ 2025.04`
  - 특허 출원 1건 (전용 자료구조 통한 중복 제거 RAG)
- [LG WebOS project](https://github.com/WebOS-yonsei/WebOS-yonsei) `2024.04 ~ 2024.06`
- 연세 생활협동조합 편의점 상품 Detection 프로젝트 (무인 편의점 모의 구현) `2024.10 ~ 2024.12`
  - YOLOv5 기반 편의점 상품 객체 탐지 모델 개발
- [꽃에 물주기 게임](https://github.com/computer-graphics-yonsei/TermProject) `2025.04 ~ 2025.06`
  - Three.js 활용 3D 장면 구현
...
- **Languages**: _Java_, Kotlin, JavaScript, _C_, _C++_, Python
- **Back-End**: Spring Framework, Spring Data JPA
- **Database**: MySQL, H2
- **DevOps**: AWS EC2, Nginx, Docker, Github Actions, Jenkins
- **AI**: Pytorch
- **Graphics**: WebGL, Three.js
- **ETC**: Git, Github, IntelliJ, Slack, Notion, LLM Integration, Arena Simulation
...
- 컴퓨터 활용능력 1급 (고용노동부) `2021.08`
- 투자자산운용사 (한국금융투자협회) `2022.02`
- 자동차운전면허2종보통 (경찰청) `2022.02`
